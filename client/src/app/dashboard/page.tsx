...
export default function Page() {
  ...
  const handleDelete = async (SavingId: object) => {
    try {
      // console.log("🚀 ~ handleDelete ~ SavingId:", SavingId)
      ...
      if (result.isConfirmed) {
        ...
        await axios.delete(`${process.env.NEXT_PUBLIC_BASE_URL}/apis/savings`, {
          data: { SavingId },
        });
                    ...
                    <tbody>
                      {dataSaving.map((transaction, index) => (
                        <tr key={transaction._id.toString()}>
                          ...
                          <td className="py-5 text-sm text-gray-900 flex gap-2">
                            <div>
                              {new Date(
                            ...
                            <div>
                              <i className="fa-solid fa-trash cursor-pointer text-red-400" onClick={()=>handleDelete(transaction._id)}></i>
                            </div>
                          </td>
                        </tr>
                      ))}
